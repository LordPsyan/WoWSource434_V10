...
void OPvPCapturePointGH::ChangeState()
{
    ...
    case OBJECTIVESTATE_ALLIANCE:
        sWorld->SendZoneText(GH_OUTDOORPVP_ZONE, sObjectMgr->GetTrinityStringForDBCLocale(LANG_OPVP_GH_LOSE_A));
        DeSpawnNPCs();
        break;
    case OBJECTIVESTATE_HORDE:
        sWorld->SendZoneText(GH_OUTDOORPVP_ZONE, sObjectMgr->GetTrinityStringForDBCLocale(LANG_OPVP_GH_LOSE_H));
        DeSpawnNPCs();
        break;
